...
import com.example.taskmanagement.utils.StatusResult
import com.example.taskmanagement.utils.StatusResult.Added
import com.example.taskmanagement.utils.StatusResult.Deleted
import com.example.taskmanagement.utils.StatusResult.Updated
import com.example.taskmanagement.utils.clearEditText
import com.example.taskmanagement.utils.hideKeyBoard
import com.example.taskmanagement.utils.longToastShow
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val taskRVVBListAdapter = TaskListAdapter(isListMutableLiveData ) { type, position, task ->
            if (type == "delete") {
                taskViewModel
                    // Deleted Task
//                .deleteTask(task)
